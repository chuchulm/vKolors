    ...
    <>
        ...
        <div> <Link to="/"> <button className="linkNosotros">Inicio</button></Link></div>
            ...
            <h1>
                ...
                y recubrimientos arquitectónicos e industriales, impermeabilizantes anticorrosivos y productos para aceras y pisos. Dentro de las pinturas
                arquitectónicas tenemos tres líneas: Vkolor Profesional, nuestra línea superior; Vkolor Hogar siendo nuestra línea intermedia y
                la línea Vkolor Industrial.
             </h1>
        </div>
    </>
    )
